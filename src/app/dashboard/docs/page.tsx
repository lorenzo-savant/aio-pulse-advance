...
export default function DocsPage() {
 ...
 <span className="mt-0.5 flex h-6 w-6 shrink-0 items-center justify-center rounded-md bg-brand-500/15 text-xs font-bold text-brand-400">
 ...
 return (
 <div key={j}>
 <span className="rounded bg-surface-200 px-1.5 py-0.5 text-sm font-semibold text-brand-700 bg-surface-800/80 text-brand-300">
 {term}
 </span>
 ...
 <input
 type="text"
 className="w-full rounded-xl border border-surface-700 py-3 pl-11 pr-10 text-sm text-white placeholder-surface-400 outline-none transition-colors focus:border-brand-500/50 border-surface-800 bg-surface-900 text-white placeholder-surface-500"
 ...
 className="mb-4 flex w-full items-center justify-between rounded-xl border border-surface-700 px-4 py-3 text-sm font-medium text-white border-surface-800 bg-surface-900 text-surface-300 lg:hidden"
 >
 ...
 {/* Mobile nav dropdown */}
 {mobileNavOpen && (
 <div className="mb-6 rounded-xl border border-surface-700 p-4 border-surface-800 bg-surface-900 lg:hidden">
 ...
 className="block w-full py-1.5 text-left text-sm text-surface-400 hover:text-brand-400"
 >
 {section.title}
 </button>
 ))}
 ...
 <button
 onClick={() => setSearchQuery('')}
 className="text-brand-600 hover:underline text-brand-400"
 >
 clear the search
 </button>
 .
 ...
 <button
 onClick={scrollToTop}
 className="fixed bottom-6 right-6 z-50 rounded-full border border-surface-700 bg-surface-900 p-3 shadow-xl transition-all hover:border-brand-500/30 hover:bg-brand-500/10"
 >
