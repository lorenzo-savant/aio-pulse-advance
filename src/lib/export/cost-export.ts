...
export function costRowsToCsv(rows: CostBreakdownRow[], meta: CostExportMeta): string {
  const lines: string[] = [
    csvCell(`AEO Pulse — API Cost Export (${meta.granularity})`),
...
<head>
<meta charset="utf-8" />
<title>AEO Pulse — API Cost Export</title>
<style>
...
<body>
  ...
  <div class="footer">Generated by AEO Pulse • AI Search Visibility Platform</div>
